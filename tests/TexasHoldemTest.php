    ...
    */
    ...
    public function bestHands()
    {
        ...
        return [
            ...
            ['7sJs9dJcJh', 'JdAh', [new Card('Js'), new Card('Jh'), new Card('Jd'), new Card('Jc'), new Card('Ah')], 'JsJhJdJcAh', 'Four of a Kind, Jacks', HighHandEvaluator::FOUR_OF_A_KIND_RANK],
            ...
            ['AcKd2d8d3d', '9dTd', [new Card('Kd'), new Card('Td'), new Card('9d'), new Card('8d'), new Card('3d')], 'KdTd9d8d3d', 'Flush, King high of Diamonds', HighHandEvaluator::FLUSH_RANK],
            ...
            ['Qh4hTc8sKd', '6d5c', [new Card('Kd'), new Card('Qh'), new Card('Tc'), new Card('8s'), new Card('6d')], 'KdQhTc8s6d', 'High Card, King', HighHandEvaluator::HIGH_CARD_RANK],
        ];
    }
}